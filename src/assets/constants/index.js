...
export const PROJECTS = [{
        ...
        image: project01,
        description: "A machine learning-based movie recommendation system that suggests personalized movie choices to users based on their preferences. The system features user authentication, movie ratings, and tailored recommendations using collaborative filtering and content-based algorithms.",
        technologies: ["Python", "Streamlit", "Pandas", "NumPy", "Scikit-learn"],
    },
    {
        title: "Gaming Club Website",
        image: project1,
        description: "A functional Gaming Club website with features like Game proposition, shopping gamers products, and gamers authentication.",
        technologies: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
    },
    {
        title: "PLAYA-AMIGOS Game",
        image: project2,
        description: "Developed Playa-Amigos, an educational game for children using Unity. The game focuses on teaching ocean conservation through interactive gameplay and engaging content.",
        technologies: ["Unity Game Engine", "C#", "Adobe", "Firebase"],
    },
    {
        title: "MAD DOCTOR Game",
        image: project3,
        description: "Created a 2D game called Mad Doctor using Unity, where the player progresses through multiple levels. The game is based on graph theory and data structures and algorithms (DSA) to provide challenging and engaging gameplay.",
        technologies: ["Unity Game Engine", "C#", "Adobe", "Firebase"],
    },
    {
        title: "Hospital Management Website",
        image: project4,
        description: "Developed a comprehensive hospital management system using HTML, CSS, PHP, and UML. The project streamlines administrative tasks, patient management, and medical records, enhancing overall efficiency and user experience.",
        technologies: ["HTML", "CSS", "PHP", "MySQL"],
    },
    {
        title: "Taekwondo website",
        image: project5,
        description: "A Taekwondo website with features like Participants and Coaches management, Events organisation, and users authentication.",
...
export const LATEST_ACTIVITIES = [{
    ...
    {
        title: "🌆 Discovering the Future: Inspiring Innovations and Insights from the Smart City Application Event (SCA24)",
        image: activity10,
    },
    {
        title: "Environmental Educator: Coastal Protection Awareness through Educational Games",
        image: activity4,
    },
    {
        title: "Environmental Educator: Coastal Protection Awareness through Educational Games",
